...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'es': {
      ...
      'synced': 'Sincronizado',
      'saved_locally_will_sync_later': 'Guardado localmente. Se sincronizará cuando haya conexión',

      // Evaluaciones
      'my_evaluations': 'Mis Evaluaciones',
      'no_evaluations_yet': 'No tienes evaluaciones aún',
      'start_evaluation_to_see_here': 'Inicia una evaluación para verla aquí',
      'no_user_logged_in': 'No hay usuario logueado',
      'error_loading_evaluations': 'Error cargando evaluaciones',
      'error_loading_more': 'Error cargando más evaluaciones',
      'evaluation_details': 'Detalles de Evaluación',
      'local_report': 'Reporte Local',
      ...
      'municipality': 'Municipio / Vereda',
      'coordinates': 'Coordenadas GPS',
      'location_obtained': 'Ubicación obtenida correctamente',
      ...
      'start_evaluation': 'Comienza una evaluación de bienestar animal',
      'local_reports_action': 'Reportes Locales',
      'pending_to_sync': 'Pendientes de sincronizar',
      'my_evaluations_action': 'Mis Evaluaciones',
      'view_full_history': 'Ver historial completo',
      'select_species_dialog': 'Selecciona una especie',
      'birds_label': 'Aves',
      'pigs_label': 'Cerdos',
      'admin_all_reports': 'Todos los Reportes (Admin)',
      'view_all_reports': 'Ver todos los reportes del sistema',
      'admin_badge': 'ADMIN',
      'no_pending_reports_to_sync': 'No hay reportes pendientes de sincronizar',
      'tap_to_go_local_reports': 'Toca aquí para ir a Reportes Locales y sincronizar',
      'user_welcome_description': 'Gestiona evaluaciones de bienestar animal',
      'admin_welcome_description': 'Panel de administración - Acceso completo al sistema',

      // Admin Reports - Filtros y búsqueda
      'search_placeholder': 'Buscar por granja, ubicación, evaluador...',
      'filter_all_species': 'Todas',
      'filter_birds': 'Aves',
      'filter_pigs': 'Cerdos',
      'filter_score_all': 'Score: Todos',
      'filter_score_50': 'Score ≥ 50%',
      'filter_score_70': 'Score ≥ 70%',
      'filter_score_85': 'Score ≥ 85%',
      'stats_reports': 'Reportes',
      'stats_users': 'Usuarios',
      'stats_average': 'Promedio',
      'no_reports_found': 'No se encontraron reportes',
      'adjust_search_filters': 'Intenta ajustar los filtros de búsqueda',
      'no_name': 'Sin nombre',
      'no_location': 'Sin ubicación',
      'no_evaluator': 'Sin evaluador',
    },
    'en': {
      ...
      'synced': 'Synced',
      'saved_locally_will_sync_later': 'Saved locally. Will sync when connection is available',

      // Evaluations
      'my_evaluations': 'My Evaluations',
      'no_evaluations_yet': 'You don\'t have any evaluations yet',
      'start_evaluation_to_see_here': 'Start an evaluation to see it here',
      'no_user_logged_in': 'No user logged in',
      'error_loading_evaluations': 'Error loading evaluations',
      'error_loading_more': 'Error loading more evaluations',
      ...
      'municipality': 'Municipality / Village',
      ...
      'start_evaluation': 'Start an animal welfare evaluation',
      'local_reports_action': 'Local Reports',
      'pending_to_sync': 'Pending sync',
      'my_evaluations_action': 'My Evaluations',
      'view_full_history': 'View full history',
      'select_species_dialog': 'Select a species',
      'birds_label': 'Birds',
      'pigs_label': 'Pigs',
      'admin_all_reports': 'All Reports (Admin)',
      'view_all_reports': 'View all system reports',
      'admin_badge': 'ADMIN',
      'no_pending_reports_to_sync': 'No pending reports to sync',
      'tap_to_go_local_reports': 'Tap here to go to Local Reports and sync',
      'user_welcome_description': 'Manage animal welfare evaluations',
      'admin_welcome_description': 'Admin Panel - Full system access',

      // Admin Reports - Filters and search
      'search_placeholder': 'Search by farm, location, evaluator...',
      'filter_all_species': 'All',
      'filter_birds': 'Birds',
      'filter_pigs': 'Pigs',
      'filter_score_all': 'Score: All',
      'filter_score_50': 'Score ≥ 50%',
      'filter_score_70': 'Score ≥ 70%',
      'filter_score_85': 'Score ≥ 85%',
      ...
      'adjust_search_filters': 'Try adjusting your search filters',
      'no_name': 'No name',
